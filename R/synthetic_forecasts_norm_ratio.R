...
#################################################################
prcp_synthetic_forecast_norm_ratio <- function(num.sim,obs.period.data,fore.period.data) {
  ...
  final.synthetic.forecasts <- data.frame('date'=obs.period.data$date,'obs'=obs.period.data$obs,simulated.forecasts, 'res'=obs.period.data$obs/simulated.forecasts)
