...
#################################################################
prcp_synthetic_forecast_norm <- function(num.sim,obs.period.data,fore.period.data) {
  ...
  final.synthetic.forecasts <- data.frame('date'=obs.period.data$date,'obs'=obs.period.data$obs,simulated.forecasts,'dif'=obs.period.data$obs-simulated.forecasts)
