...
qq  = load('./data/inflow_79.txt','-ascii') ; % 01/10/1904 - 30/09/2015
ee1  = load('./data/evaporation.txt','-ascii') ; % 01/10/1904 - 30/09/2015
ee  = ee1(1:36525);
w   = load('./data/demand.txt','-ascii') ;
%qe2016 = load('./data/data2016.txt','-ascii') ; % 1/10/2015 - 30/09/20

dn = datenum(2000,1,1):datenum(2099,12,31);
dn_sim = datenum(2080,1,1):datenum(2099,12,31); % simulation horizon 01/1/2080 - 31/12/2099
...
disp(J)
save ./output/workspaceSDP_79.mat
